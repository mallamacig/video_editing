...
my_clip = VideoFileClip("immagine1.mp4", audio=True)  #  The video file with audio enabled

w,h = my_clip.size  # size of the clip

# A CLIP WITH A TEXT AND A BLACK SEMI-OPAQUE BACKGROUND

txt = TextClip("THE WATERMARK", font='Anton.ttf',
...
final.duration = 5
final.write_videofile("test_video_watermark2.mp4",fps=24,codec='libx264')